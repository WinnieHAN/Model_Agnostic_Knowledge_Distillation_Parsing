...
def main():
    ...
    #     network.load_state_dict(torch.load('models/parsing/biaffine/network.pt'))  # TODO: 1.16
    # elif args.treebank == 'ctb':
    #     network.load_state_dict(torch.load('ctb_models/parsing/biaffine/network.pt'))  # TODO: 1.16
    network.to(device)

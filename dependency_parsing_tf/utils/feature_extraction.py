...
class DataConfig:  # data, embedding, model path etc.
    # Data Paths
    data_dir_path = "./data/ptb"
    train_path = "train.conllu"
    valid_path = "dev.conllu"
    ...
    # dump - vocab
    dump_dir = "./dependency_parsing_tf/data/dump"
...
def load_datasets(load_existing_dump=False):
    ...
    print "Done!"
    dataset.model_config.word_features_types = 18# len(dataset.train_inputs[0][0])
    dataset.model_config.pos_features_types = 18#len(dataset.train_inputs[1][0])
    dataset.model_config.dep_features_types = 12#len(dataset.train_inputs[2][0])
    dataset.model_config.num_features_types = 48#dataset.model_config.word_features_types + \
                                               # dataset.model_config.pos_features_types + dataset.model_config.dep_features_types
    dataset.model_config.num_classes = 3#len(dataset.train_targets[0])
